 ...
 *Этап 2 - Разработка и оценка базовых моделей*
 *Этап 3 - Обработка данных-документов для извлечения информации из графических данных*
 *Этап 4 - Сборка базовой модели полного цикла*
 *Этап 5 - Интерпретация результатов и согласование с заказчиком*
 
 *Этап 6 - Разработка и оценка MVP модели*
 
 *Этап 7 - Интерпретация моделей*  
 *Этап 8 - Подготовка финального отчета для бизнеса и согласовании дальнейших планов развития*
