...
Структура Baseline весьма похожа на структуру MVP, однако вместо всем моделей будет использоваться `Llama 3.2`. Кроме того, не будет осуществляться никакой генерации запросов для извлчения данных из картики.
